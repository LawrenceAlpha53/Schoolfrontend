// AIInsights.jsx – Same card dimensions as SecurityCommandCenter, with AI content
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from '../api/axios';
import {
  Brain, Loader2, ArrowRight, Sparkles,
...
const AIInsights = () => {
  ...
  // Loading skeleton – same w-174 and p-6 as the old card
  if (isLoading) {
    return (
      <div className="bg-white rounded-2xl p-6 shadow-sm border w-174">
  ...
  return (
    <div
      ...
      className="bg-white rounded-2xl p-6 shadow-sm border w-174 hover:shadow-md transition-all duration-200 cursor-pointer group"
    >
      {/* Title – matches old card's h2 style */}
      <h2 className="text-xl font-bold mb-5 text-gray-800 flex items-center gap-2.5">
      ...
      {/* Content area – replaces old 2x2 grid with landscape AI metrics */}
